...
import mobileLoginImg from "../assets/mobile-login.svg";
...
function Producsts() {
  return (
    <div id="product">
      {/* about text */}
      <div className="px-14 lg:px-14 max-w-screen-2xl mx-auto my-8">
      ...
      {/* company stats */}
      <div className="px-14 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16" id="testimonial">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="md:w-1/3">
            <img src={Maecenas} alt="" width={350} />
          </div>
